...
class Game {
  ...
  constructor(player, name) {
    ...
    //* First player
    this.tables[0][0][0] = 3;//First line
    this.tables[0][0][1] = 3;
    this.tables[0][0][2] = 11;
    this.tables[0][0][3] = 11;
    this.tables[0][0][4] = 0;
    this.tables[0][0][5] = 11;
    this.tables[0][0][6] = 11;
    this.tables[0][0][7] = 3;
    this.tables[0][0][8] = 3;
    this.tables[0][0][9] = 2;
    this.tables[0][1][0] = 5;//Second line
    this.tables[0][1][1] = 2;
    this.tables[0][1][2] = 6;
    this.tables[0][1][3] = 8;
    this.tables[0][1][4] = 4;
    this.tables[0][1][5] = 11;
    this.tables[0][1][6] = 5;
    this.tables[0][1][7] = 7;
    this.tables[0][1][8] = 5;
    this.tables[0][1][9] = 11;
    this.tables[0][2][0] = 1;//Third line
    this.tables[0][2][1] = 7;
    this.tables[0][2][2] = 2;
    this.tables[0][2][3] = 3;
    this.tables[0][2][4] = 2;
    ...
    this.tables[0][2][7] = 2;
    this.tables[0][2][8] = 6;
    this.tables[0][2][9] = 10;
    this.tables[0][3][0] = 6;//Fourth line
    this.tables[0][3][1] = 4;
    this.tables[0][3][2] = 9;
    this.tables[0][3][3] = 2;
    this.tables[0][3][4] = 6;
    ...
    //* Second player
    this.tables[1][9][9] = 3;//First line
    this.tables[1][9][8] = 3;
    this.tables[1][9][7] = 11;
    this.tables[1][9][6] = 11;
    this.tables[1][9][5] = 0;
    this.tables[1][9][4] = 11;
    this.tables[1][9][3] = 11;
    this.tables[1][9][2] = 3;
    this.tables[1][9][1] = 3;
    this.tables[1][9][0] = 2;
    this.tables[1][8][9] = 5;//Second line
    this.tables[1][8][8] = 2;
    this.tables[1][8][7] = 6;
    this.tables[1][8][6] = 8;
    this.tables[1][8][5] = 4;
    this.tables[1][8][4] = 11;
    this.tables[1][8][3] = 5;
    this.tables[1][8][2] = 7;
    this.tables[1][8][1] = 5;
    this.tables[1][8][0] = 11;
    this.tables[1][7][9] = 1;//Third line
    this.tables[1][7][8] = 7;
    this.tables[1][7][7] = 2;
    this.tables[1][7][6] = 3;
    this.tables[1][7][5] = 2;
    ...
    this.tables[1][7][2] = 2;
    this.tables[1][7][1] = 6;
    this.tables[1][7][0] = 10;
    this.tables[1][6][9] = 6;//Fourth line
    this.tables[1][6][8] = 4;
    this.tables[1][6][7] = 9;
    this.tables[1][6][6] = 2;
    this.tables[1][6][5] = 6;
